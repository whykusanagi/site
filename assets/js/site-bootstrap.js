...
import { Toast } from 'https://cdn.whykusanagi.xyz/corrupted-theme/@0.3.2/src/lib/toast.js';
window.Toast = Toast;
...
import { CorruptedParticlesBackground } from 'https://cdn.whykusanagi.xyz/corrupted-theme/@0.3.2/src/lib/corrupted-particles-background.js';
...
if (document.body.classList.contains('crt-on')) {
  import('https://cdn.whykusanagi.xyz/corrupted-theme/@0.3.2/src/lib/crt-effects.js').then(({ CRTEffects }) => {
...
if (mandalaEl) {
  import('https://cdn.whykusanagi.xyz/corrupted-theme/@0.3.2/src/lib/corrupted-mandala.js').then(({ CorruptedMandala }) => {
...
if (heroEl) {
  import('https://cdn.whykusanagi.xyz/corrupted-theme/@0.3.2/src/lib/animation-blocks.js').then(async ({ TerminalBoot, TitleDecoder }) => {
...
if (clockEl) {
  import('https://cdn.whykusanagi.xyz/corrupted-theme/@0.3.2/src/lib/clock-widget.js').then(({ ClockWidget }) => {
...
function initNsfwReveal() {
  ...
  import('https://cdn.whykusanagi.xyz/corrupted-theme/@0.3.2/src/lib/nsfw-reveal.js').then(({ NsfwReveal }) => {
    targets.forEach(el => {
